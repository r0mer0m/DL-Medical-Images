...
for N in SAMPLE_AMOUNTS:
    ...
    save_path = SAVE_DIRECTORY/f"{DISEASE.lower()}-feature-extractor-{N}.pth"
    ...
    save_path = SAVE_DIRECTORY/f"{DISEASE.lower()}-fine-tune-all-{N}.pth"
...
for i, N in enumerate(SAMPLE_AMOUNTS):
    ...
    load_path = SAVE_DIRECTORY/f"{DISEASE.lower()}-feature-extractor-{N}.pth"
    ...
    load_path = SAVE_DIRECTORY/f"{DISEASE.lower()}-fine-tune-all-{N}.pth"
    ...
    save_path = SAVE_DIRECTORY/f"{DISEASE.lower()}-grad-unfr-diff-lr-training-{N}.pth"
...
with open(f'results/{DISEASE.lower()}_feature_extractor.json', 'w') as f:
    f.write(feature_extractor)

fine_tune_all = json.dumps(fine_tune_all)
with open(f'results/{DISEASE.lower()}_fine_tune_all.json', 'w') as f:
    f.write(fine_tune_all)
    
grad_unfr_diff_lr = json.dumps(grad_unfr_diff_lr)
with open(f'results/{DISEASE.lower()}_grad_unfr_diff_lr.json', 'w') as f:
